...
electric_to_use$Voltage <- format(electric_to_use$Voltage, decimal.mark = ".")
...
#plot2
plot(datetime,as.numeric(electric_to_use$Voltage),type="l",ylab="Voltage")
#plot3
...
#plot4
plot(datetime,as.numeric(electric_to_use$Global_reactive_power),type="l",ylab="Global Reactive Power")
